...
export class CreateReport {
  ...
  async execute(reportData: CreateReportDTO) {
    ...
    const {veiculoFurtado, localOcorrencia, dataOcorrencia, periodoOcorrencia} = reportData
    ...
    const savedRegistration = await this.carRegistrationProvider.createCarRegistration(registration)
    ...
    vehicle.emplacamento = envs.API.sideApi + "/car-registration/" + savedRegistration.id;
